					...
					<div className="space-y-6">
						...
						<div className="space-y-3">
							...
							<p className="max-w-2xl text-base leading-7 text-slate-200/80 sm:text-lg">
								The browser sends click events, Flask checks the session,
								updates Postgres, and Socket.IO pushes the new score back
								immediately.
							</p>
						</div>
					</div>
						...
						{!session ? (
							...
							<div className="rounded-3xl border border-white/10 bg-slate-950/40 p-4">
								...
								<div className="flex flex-col gap-3">
									<p className="h-12  rounded-2xl border border-white/10 bg-slate-900/80 px-4 py-3 text-xl text-white outline-none transition placeholder:text-slate-400 focus:border-sky-400/60 text-center">
										{username}
									</p>
								</div>
								<button
